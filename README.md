...
> **v0.3.7：让每日资讯的挑选标准真正生效，并补齐回顾、记忆候选与对话里的几处表述。** 资讯执行轮现在自带质量标准（要相关、要有实质新进展、去重、过滤空泛营销与早报合集），回顾不再复述敏感信息，记忆候选只记长期事实与偏好。
...
版本 **0.3.7**。仓库：https://github.com/iamhej/dsh-claudia 。面向单用户本机，macOS 优先；与 Today、DeepSeek 无官方隶属或背书关系。
